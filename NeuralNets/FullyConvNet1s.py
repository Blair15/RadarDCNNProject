...
m keras.layers import Dense, Dropout, Activation, Flatten
...
def load_data():
    ...
    ##We have 60 1 second recordings for each of the 39 files
    nb_train_samples = 1950

    X_train = np.zeros((nb_train_samples, 128000, 2), dtype="uint8")
    ...
    nb_test_samples = 390
    X_test = np.zeros((nb_test_samples, 128000, 2), dtype="uint16")
...
def VGG_16(weights_path=None):
    model = Sequential()
    model.add(Convolution1D(128, 800, padding='same', activation='relu', input_shape=(128000,2)))
    #model.add(Convolution1D(256, 16000, padding='same', activation='relu'))
    model.add(MaxPooling1D(4))

    #model.add(Convolution1D(512, 16000, padding='same', activation='relu'))
    model.add(Convolution1D(128, 400, padding='same', activation='relu'))
    model.add(MaxPooling1D((4)))

    #model.add(Convolution1D(1024, 8000, padding='same', activation='relu'))
    #model.add(Convolution1D(1024, 8000, padding='same', activation='relu'))
    ...
    #model.add(Convolution1D(1024, 8000, padding='same', activation='relu'))
    #model.add(Convolution1D(1024, 8000, padding='same', activation='relu'))
    #model.add(Convolution1D(512, 2000, padding='same', activation='relu'))
    #model.add(MaxPooling1D(4))
